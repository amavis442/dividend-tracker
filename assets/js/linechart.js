...
const lineChart = function (canvasName, cdata, clabels, ctitle, csubTitle, csign) {
	var s = cdata.length;
    var cdatasets = [];
    for (var n = 0;n < s; n++) {
...
$(function(){
	...
	for (var n = 0; n < chartElements.length; n++) {
		...
		lineChart(chartElement.id, chartData, chartLabels, chartTitle, chartSubTitle, chartSign);
	}
});
