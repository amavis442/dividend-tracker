 ...
 */
final class Version20200716150621 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD broker VARCHAR(40) DEFAULT NULL, CHANGE calendar_id calendar_id INT DEFAULT NULL, CHANGE stocks stocks INT DEFAULT NULL');
        $this->addSql('ALTER TABLE position CHANGE allocation_currency_id allocation_currency_id INT DEFAULT NULL, CHANGE price price INT DEFAULT NULL, CHANGE closed closed TINYINT(1) DEFAULT NULL, CHANGE profit profit INT DEFAULT NULL, CHANGE allocation allocation INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE `transaction` CHANGE allocation_currency_id allocation_currency_id INT DEFAULT NULL, CHANGE position_id position_id INT DEFAULT NULL, CHANGE price price INT DEFAULT NULL, CHANGE profit profit INT DEFAULT NULL, CHANGE allocation allocation INT DEFAULT NULL, CHANGE broker broker VARCHAR(255) DEFAULT \'Trading212\' NOT NULL, CHANGE avgprice avgprice INT DEFAULT NULL');
        /* mariadb does not support rename index before 10.5
        ...
        $this->addSql('ALTER TABLE `transaction` RENAME INDEX idx_f5299398a76ed395 TO IDX_723705D1A76ED395');
        $this->addSql('ALTER TABLE `transaction` RENAME INDEX idx_f5299398556b180e TO IDX_723705D1556B180E');
        */
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment DROP broker, CHANGE calendar_id calendar_id INT DEFAULT NULL, CHANGE stocks stocks INT DEFAULT NULL');
        $this->addSql('ALTER TABLE position CHANGE allocation_currency_id allocation_currency_id INT DEFAULT NULL, CHANGE price price INT NOT NULL, CHANGE closed closed TINYINT(1) DEFAULT \'NULL\', CHANGE profit profit INT DEFAULT NULL, CHANGE allocation allocation INT DEFAULT NULL');
