 ...
 */
final class Version20210324192648 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO currency SET `symbol`="GB",`description`="Pence sterling", `sign` = "&pound;"');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DELETE FROM currency WHERE `symbol` = "GB"');
    }
}
